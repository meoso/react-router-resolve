 ...
 * @description Wrapper for React Router's Router component that provides
 * defaultRoute and ensureTrailingSlash options
 */
const R3Router = (WrappedRouter) => {
...
const BrowserRouter = R3Router(BrowserRouterDom);
const MemoryRouter = R3Router(MemoryRouterDom);
const StaticRouter = R3Router(StaticRouterDom);
const HashRouter = R3Router(HashRouterDom);
const Router = R3Router(RouterDom);
export {
    BrowserRouter,
    MemoryRouter,
    StaticRouter,
